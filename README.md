...
- **Por día**: actividades del cronograma parroquial, responsables (grupos parroquiales), alimentación, y el equipo interno del día (2 de cocina y 1 de liturgia). Al abrirla durante las misiones, muestra el día de hoy automáticamente.
...
- **Equipo**: los 10 seminaristas, los roles fijos y el resumen de la distribución de turnos.
...
- **Liturgia**: 1 por día. Todos sirven 1 vez; Armando Celis (responsable) sirve en la llegada y la despedida.
